...
public final class __start_jspx extends  weblogic.servlet.jsp.JspBase  implements weblogic.servlet.jsp.StaleIndicator {
    ...
    public static boolean _staticIsStale(weblogic.servlet.jsp.StaleChecker sci) {
        if (sci.isResourceStale("/Start.jspx", 1222195479984L ,"10.3.0.0","America/Denver")) return true;
        return false;
    }
    ...
    private boolean _jspx___tag4(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, PageContext pageContext, javax.servlet.jsp.tagext.JspTag activeTag, oracle.adfinternal.view.faces.unified.taglib.UnifiedFormTag parent) throws Throwable
    {
        ...
        javax.servlet.jsp.JspWriter out = pageContext.getOut();
        weblogic.servlet.jsp.ByteWriter bw = (weblogic.servlet.jsp.ByteWriter) out;
         oracle.adfinternal.view.faces.unified.taglib.nav.UnifiedCommandButtonTag __tag4 = null ;
        int __result__tag4 = 0 ;

        if (__tag4 == null ){
            __tag4 = new  oracle.adfinternal.view.faces.unified.taglib.nav.UnifiedCommandButtonTag ();
            weblogic.servlet.jsp.DependencyInjectionHelper.inject(pageContext, __tag4);
        }
        __tag4.setPageContext(pageContext);
        __tag4.setParent(parent);
        __tag4.setJspId("id4");
        __tag4.setText( weblogic.servlet.jsp.ELHelper.createValueExpression("#{storefrontuiBundle.START_SHOPPING}",java.lang.Object.class,pageContext, null ));
        __tag4.setAction( weblogic.servlet.jsp.ELHelper.createMethodExpression("start",java.lang.String.class,new Class[]{},pageContext, null ));
        _activeTag=__tag4;
